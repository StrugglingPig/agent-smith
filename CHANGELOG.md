...
## [0.133.0](https://github.com/StrugglingPig/agent-smith/compare/v0.132.0...v0.133.0) (2026-08-19)


### Features

* a done ledger entry stays done, and every transition is on the trail (p0374a) ([be98d96](https://github.com/StrugglingPig/agent-smith/commit/be98d96d0bde6f42e3255549f85e3c2f22e82cda))
* a failure names itself, and delivery is accounted for ([ed94a0d](https://github.com/StrugglingPig/agent-smith/commit/ed94a0dc30594833797b1af5c9412ca99d58cf37))
* a failure names itself, and delivery is accounted for (p0419, p0420) ([0bf2159](https://github.com/StrugglingPig/agent-smith/commit/0bf21593a90cd9c9269d1683f666d81f44c18778))
* a live-target finding cites an endpoint, and the citation is resolved (p0429a) ([8599be7](https://github.com/StrugglingPig/agent-smith/commit/8599be7d05f336d2524910cf26109b72cd9d4da4))
* a master cites shared methodology and the loader inlines it (p0313b) ([1d27afd](https://github.com/StrugglingPig/agent-smith/commit/1d27afd1045df310a4953f14ad1a51787de77999))
* a mid-run question is answerable where it is shown (p0453) ([7feaf2e](https://github.com/StrugglingPig/agent-smith/commit/7feaf2ee191f9297e7ea14860dc39f3e162c04ee))
* a recorded run replays without a model (p0427) ([90cb986](https://github.com/StrugglingPig/agent-smith/commit/90cb98609a452e43bada9e17777a89cc4a7c77e7))
* a run can be driven by an external agent instead of a provider (p0416) ([c74aab3](https://github.com/StrugglingPig/agent-smith/commit/c74aab3683dcb5cdd938e53fa71236dd8ec71be9))
* a run proves its preconditions before it spends on them (p0428) ([308d81d](https://github.com/StrugglingPig/agent-smith/commit/308d81d389393e4065f94d570a57e40c57cc2c0f))
* a run records itself (p0423) ([d4db4d4](https://github.com/StrugglingPig/agent-smith/commit/d4db4d4fe2ae0f6757470a69155fc7e78489734d))
* a scan states what it looked for, and its findings are substantiated (p0429) ([a757a64](https://github.com/StrugglingPig/agent-smith/commit/a757a6405437a0f173b56e7ac4200c04e00931b7))
* a waiting ticket says who it waits for (p0454) ([a61ed66](https://github.com/StrugglingPig/agent-smith/commit/a61ed66bc7cdbace7456d5838a405a2997b0ac12))
* acceptance-driven completion — keystone + master gate on the ratified contract (p0340) ([d7d1deb](https://github.com/StrugglingPig/agent-smith/commit/d7d1debc048af2753db4cc221113e39df53b2f8a))
* acceptance-driven completion — keystone + master gate on the ratified contract (p0340) ([47f371c](https://github.com/StrugglingPig/agent-smith/commit/47f371c4f41f40f97b3687b5acdd777150e27d8a))
* agent-smith demo — the whole loop on a bundled sample project (p0326) ([e846c32](https://github.com/StrugglingPig/agent-smith/commit/e846c32e61eeb3ecd9cb4a8f389d494b140d3336))
* agent-smith doctor — active preflight checks for every silent-failure class (p0324) ([c33cf53](https://github.com/StrugglingPig/agent-smith/commit/c33cf537c1652b938fff8eeb83eb683ca9b8a5d4))
* answerable questions, a ticket that says who it waits for, and a config UI that shows what it holds (p0453–p0456) ([4065854](https://github.com/StrugglingPig/agent-smith/commit/4065854dfb840427d5e96e820792c91535fb78af))
* any ticket becomes an ordered set of phase specs (p0393a) ([e5333bd](https://github.com/StrugglingPig/agent-smith/commit/e5333bd0f810fdb76bd80da7e03a8242d5d56a49))
* any ticket becomes an ordered set of phase specs (p0393a) ([7a6893e](https://github.com/StrugglingPig/agent-smith/commit/7a6893ee36ef75c5fe70c019880ff6bf3b9103aa))
* cancel enforcement, ticket-scoped provisioning, cost-honest capacity (p0330-p0332) ([d9bdc93](https://github.com/StrugglingPig/agent-smith/commit/d9bdc93a6f41beeecc0dce5c565352954b8393a8))
* cancel is persistent state, enforced by durable force-kill (p0330 backend) ([9c9578a](https://github.com/StrugglingPig/agent-smith/commit/9c9578a128a08c2c3cbf888fbd91b433a5b82a55))
* cancel state visible in every run state; queued runs cancellable (p0330 dashboard) ([ff2282a](https://github.com/StrugglingPig/agent-smith/commit/ff2282aa05dce1077681e2f52c0d609ba1c34f90))
* capacity queue with FIFO position, pipeline-aware sandbox sizing, init re-run fix (p0320a-d, p0321) ([5194d5c](https://github.com/StrugglingPig/agent-smith/commit/5194d5c98476cf7a08c7ccfa6ec2b02793d32156))
* close the placeholder leak and make it undriftable (p0313) ([af22b8b](https://github.com/StrugglingPig/agent-smith/commit/af22b8beae68c90dac73e1c31c146ed548f98904))
* close the wiring — real run story data + connections config entity (p0344b, p0345b) ([4705aa6](https://github.com/StrugglingPig/agent-smith/commit/4705aa6f9d1259d27982dc5fff9eeda92d952d47))
* collapse per-repo per-toolchain sandboxes + align footprint (p0336c) ([17ee73c](https://github.com/StrugglingPig/agent-smith/commit/17ee73c6f6dd4940dc0c66d7c245d37860e8ea92))
* collapse per-repo per-toolchain sandboxes + align footprint (p0336c) ([2fb93f9](https://github.com/StrugglingPig/agent-smith/commit/2fb93f9530eded8f2464a7e00fbd3f40979cedf5))
* compaction hysteresis rescue + RED persistence + wall-time ledger (p0362+p0363) ([#450](https://github.com/StrugglingPig/agent-smith/issues/450)) ([fae6058](https://github.com/StrugglingPig/agent-smith/commit/fae605849a22d2f45e9bdd8d537375df7302418a))
* config import in the studio UI (p0352) ([245ffa0](https://github.com/StrugglingPig/agent-smith/commit/245ffa0e1b4b10402cd7da702e4579f687f6a885))
* config import in the studio UI + model-role/pricing stringency (p0351, p0352) ([0f22355](https://github.com/StrugglingPig/agent-smith/commit/0f2235588b82235be56b82c603a29334447a631b))
* config in a DB entity-document store (p0349) ([f4f90eb](https://github.com/StrugglingPig/agent-smith/commit/f4f90eb2d581afb6c52ce68b5c432679889a6357))
* config in a DB entity-document store (p0349) ([0686b73](https://github.com/StrugglingPig/agent-smith/commit/0686b7353c60ac2a75ef7053b37c82406c3bc729))
* config live-reload, editable settings, web/http tools (p0353) ([5fce037](https://github.com/StrugglingPig/agent-smith/commit/5fce03711b3b58188272db54b6ae3c4be1191568))
* config semantics — capabilities descriptor, discovery-fed repo endpoint, entity v2, drift facts (p0345c backend) ([1146338](https://github.com/StrugglingPig/agent-smith/commit/1146338dcb5334988d25833233c8bdadbe92887d))
* config semantics — capabilities-driven forms, discovery repo picker, pipeline/resolution truth-fix, full agent surface, drift story (p0345c) ([2c4c28d](https://github.com/StrugglingPig/agent-smith/commit/2c4c28d7f4e2dc46e94acf0748e10765cd292808))
* config semantics — capabilities-driven studio forms, real repo picker, pipeline/resolution truth-fix, dual-world Repositories, config-reads drift story (p0345c dashboard) ([9ba2e0f](https://github.com/StrugglingPig/agent-smith/commit/9ba2e0f8bc65b7a80fb69bd886069b371fc80851))
* Config Studio offers every tracker field and says what is missing (p0392) ([ab32f82](https://github.com/StrugglingPig/agent-smith/commit/ab32f8270b7aa654ef0431e9557987317f88783e))
* config studio stringency — model roles + pricing (p0351) ([6afc3a1](https://github.com/StrugglingPig/agent-smith/commit/6afc3a14922d651ade1c95a7a36d6f6b6f1cac9a))
* config studio UI — editable relational catalog + audit (p0345) ([27becd2](https://github.com/StrugglingPig/agent-smith/commit/27becd2c5ec5823723a9ac0df37b60e246f5ae40))
* **config:** export.yml endpoint; fix(harness): real-scanners opt-in is a parameter, not a process env toggle (p0343b) ([23ece72](https://github.com/StrugglingPig/agent-smith/commit/23ece724423f2b38c98135ff142d050c03d11fd5))
* context integrity + run trust — token-only compaction, pinned ticket, 200k window, terminal cancel, python3 carrier payload, honest writes, budget bar (p0357) ([8f07d00](https://github.com/StrugglingPig/agent-smith/commit/8f07d00ac506544394750289196556e9e00799ff))
* context integrity + run trust — token-only compaction, pinned ticket, terminal cancel, python3 carrier, honest writes, budget bar (p0357) ([3f1f4af](https://github.com/StrugglingPig/agent-smith/commit/3f1f4af28b1be136553c2f2655109bba87b50317))
* context-level scoping (p0336b) ([8877606](https://github.com/StrugglingPig/agent-smith/commit/8877606709613783763a0e7eccd8ec4eeef31293))
* context-level scoping (p0336b) ([9c1c43e](https://github.com/StrugglingPig/agent-smith/commit/9c1c43e0a194d93f0e1f398aaf32f92cf8fa2886))
* continuous master context — in-loop compaction middleware (p0341d) ([823c510](https://github.com/StrugglingPig/agent-smith/commit/823c5103dc4b9b22f883b991b78fc84d163d8c75))
* cost truth + duplicate-work telemetry — unpriced models surface, per-model phase pricing, repeated-tool-call counter (p0361) ([#448](https://github.com/StrugglingPig/agent-smith/issues/448)) ([d74b12b](https://github.com/StrugglingPig/agent-smith/commit/d74b12b264825630e4af7969bcef60ec43084785))
* cost-honest capacity — requests-based quota pin, honest defaults, reserved resource-time visible (p0332) ([81481d5](https://github.com/StrugglingPig/agent-smith/commit/81481d59b5d198ac936f64979c32d1390b39a300))
* dashboard favicon (brand "a" mark) ([b339842](https://github.com/StrugglingPig/agent-smith/commit/b3398424f38dc96dc9a7e0dd21d8c7cbfb49f85f))
* dashboard mock fidelity — contextual rail, catalog studio, inflow pill, beat cards + side rail (p0343b) ([1146da4](https://github.com/StrugglingPig/agent-smith/commit/1146da42f79fa3d2d7a7bb1d57a70bbc0e255d04))
* dashboard redesign — mission control + run story view + config studio (p0343–p0345) ([4e1ced3](https://github.com/StrugglingPig/agent-smith/commit/4e1ced370bcf8ff38eac1cf3f13a1117af52634b))
* **dashboard:** join the run-detail snapshot — ledger/acceptance reach the story (p0344b) ([45dc2c2](https://github.com/StrugglingPig/agent-smith/commit/45dc2c2302f45b3b91ea309a6aee1a8f99ed3ecd))
* **dashboard:** mission control — state-ranked runs home + inline answering (p0343) ([d019e7c](https://github.com/StrugglingPig/agent-smith/commit/d019e7cc4bd7c488d0a0ab4e71b0c1b5a564b2de))
* DB-backed editable config behind IConfigStore — file store + audit + REST (p0345 backend) ([5100265](https://github.com/StrugglingPig/agent-smith/commit/51002651dbc75898b4fb9f254554bd90883a04a5))
* decision category projection and harness step-attribution proof (p0388c) ([3cdb1fc](https://github.com/StrugglingPig/agent-smith/commit/3cdb1fc83fadaf4fa7896d22fe8134d1404f256f))
* doctor, embedded skills, demo, durable dialogue, expectation negotiation + goldens, docs sweep (p0324-p0329, p0335) ([64351ac](https://github.com/StrugglingPig/agent-smith/commit/64351ac81492b80ea283d40b85d82bd6db3ad7fc))
* done stays done, and the durable-dialogue spine gets its proof back (p0374a + p0393b) ([799e641](https://github.com/StrugglingPig/agent-smith/commit/799e6414d2e937eda65ec9112e995701460efe1d))
* durable dialogue — checkpoint at the ask, resume on the answer (p0327) ([215de76](https://github.com/StrugglingPig/agent-smith/commit/215de76f25b1af954f7e239be79c76774fc11f49))
* durable per-repo PR outcomes + Pull Requests read surface (p0347-be) ([99734ed](https://github.com/StrugglingPig/agent-smith/commit/99734eda9b65eb7112138c2e8799cb26039ad37e))
* durable progress ledger — core (p0341) ([7192c0e](https://github.com/StrugglingPig/agent-smith/commit/7192c0e745351992cfb72e78672440202342d45f))
* durable progress ledger — core (p0341) ([b3a6ca4](https://github.com/StrugglingPig/agent-smith/commit/b3a6ca47eaa49daabd409024c6f07a91d4f966b7))
* every step reports where its wall-clock went (p0404) ([d1782be](https://github.com/StrugglingPig/agent-smith/commit/d1782bee02fdbcc243d1a7fe86fc289e5c2e3bad))
* expectation negotiation — ratified Soll block as the run's acceptance contract (p0328) ([b1c0e1a](https://github.com/StrugglingPig/agent-smith/commit/b1c0e1a956915479e4b5a23c56fcb18c55140655))
* expectation replay goldens — eval mechanics, anonymized fixtures, ratification metrics (p0329) ([7e31d4b](https://github.com/StrugglingPig/agent-smith/commit/7e31d4bb8d79f4101f1e4dc014749145191c8ef1))
* keystone read-only exemption, skip unchanged repos, live cost, viewer perf, rename-poison guard (p0355) ([1e41750](https://github.com/StrugglingPig/agent-smith/commit/1e41750f695c43ece642d66381e383e7c9a77679))
* live-eventing + observability + ledger + keystone-contract-gate (p0366–p0373) ([#453](https://github.com/StrugglingPig/agent-smith/issues/453)) ([8b2789a](https://github.com/StrugglingPig/agent-smith/commit/8b2789ae6f4fbdc45df413a7281f5a52ee5e785f))
* load-bearing ledger — open, budget-bounded, verified master loop (p0341c) ([04a977c](https://github.com/StrugglingPig/agent-smith/commit/04a977c018c4748e634da35b042e35cd6fbdda2d))
* master exit paths — a working way out for the coding master (p0391) ([2cb06ff](https://github.com/StrugglingPig/agent-smith/commit/2cb06ff0bcb4a2cf5877e98e97e438e5ec233d25))
* master working-set overlay — mechanization affordance, compiler scout, durable mid-run ledger, context telemetry (p0356) ([6d0680b](https://github.com/StrugglingPig/agent-smith/commit/6d0680bc429cdeed93de6cc210bad0cdf7e25c99))
* memory substrate + agnostic principles + drain fix + registry-auth fallback + dashboard polish (p0372/p0375/p0378/p0379/p0380) ([#461](https://github.com/StrugglingPig/agent-smith/issues/461)) ([38591e8](https://github.com/StrugglingPig/agent-smith/commit/38591e83e5ded0cccb6d9eeb2304b489b68786c2))
* merge respects master read-set, stops laundering static-pattern FPs (p0333) ([f022abd](https://github.com/StrugglingPig/agent-smith/commit/f022abd5ee1ec7d18125779abddd63a7c4f9e564))
* merge respects master read-set, stops laundering static-pattern FPs (p0333) ([84ad811](https://github.com/StrugglingPig/agent-smith/commit/84ad811f0550822d944a48df6d2e1d80bdc944dd))
* mid-run checkpoint pushes — a dying run keeps its work (p0360) ([e598d26](https://github.com/StrugglingPig/agent-smith/commit/e598d26876bb753593c6ac5d8e87f4c5bb89c15b))
* mock fidelity — shell toggle, catalog rail, wires, export, beat cards, side rail (p0343b) ([df593fd](https://github.com/StrugglingPig/agent-smith/commit/df593fd297a06d29d6ec9ebbbf0e9ce872a1a53b))
* model-owned progress ledger + staleness-based reminder (p0359) ([c5f78c8](https://github.com/StrugglingPig/agent-smith/commit/c5f78c87159dfdaa29cdafecaaa52a135fdd29ed))
* no startup path throws, and the Studio shows what is missing (p0391b + p0392) ([dac2605](https://github.com/StrugglingPig/agent-smith/commit/dac26052d3791e06984d14f81e8bba1aac8b58c8))
* one code pipeline, a real build gate, the pin on 4.0.0 (p0393) ([c91e816](https://github.com/StrugglingPig/agent-smith/commit/c91e8160b6a944be7537d6f6025e729852034294))
* one code pipeline, a real build gate, the pin on 4.0.0 (p0393) ([d6cde18](https://github.com/StrugglingPig/agent-smith/commit/d6cde1884fd76da9f2559c6788472563121a34ed))
* one command is one step — the batch path is gone (p0312d) ([0f6d686](https://github.com/StrugglingPig/agent-smith/commit/0f6d686df56bee427f466197d1a304fe43b42020))
* one gate decides delivery, and it reads the branch (p0420, p0421) ([14917c6](https://github.com/StrugglingPig/agent-smith/commit/14917c6e1d77cb5c28687b44054571cdc72a2256))
* one skills root, Triage retires, pr-review gets its master (p0312a p0312b p0312c) ([f8935b8](https://github.com/StrugglingPig/agent-smith/commit/f8935b83bc2cdefeed0aa4dd534cbe3accfebb81))
* one skills root, Triage retires, pr-review gets its master (p0312a/b/c) ([6c69213](https://github.com/StrugglingPig/agent-smith/commit/6c692139a663aa11e684b80f065fa4857cb920c8))
* open, budget-bounded, verified master loop + continuous context (p0341c/p0341d) ([48d5ec4](https://github.com/StrugglingPig/agent-smith/commit/48d5ec4de493edf3ed5a98d7dbf6beb2d630a428))
* p0361 pricing truth duplicate metric ([#455](https://github.com/StrugglingPig/agent-smith/issues/455)) ([e056cae](https://github.com/StrugglingPig/agent-smith/commit/e056caeafb2edb4011e669b28fc6bac8bf3c7d52))
* **p0390:** derive a versioned work spec from the ticket ([15a38ea](https://github.com/StrugglingPig/agent-smith/commit/15a38eab0467b656d6d6e605922726e1c50a4ca5))
* **p0390:** master input, hand-back routing, spec exclusion and viewer ([c984394](https://github.com/StrugglingPig/agent-smith/commit/c9843945052ca9829cbdbe68ffc71b8ab8109a31))
* **p0390:** work-spec contract, serializer and validator ([0d0edb6](https://github.com/StrugglingPig/agent-smith/commit/0d0edb65f136116165a11f775ec812584a2ea52c))
* **p0391a:** a blocking finding disables the trigger, not the process ([9a1215c](https://github.com/StrugglingPig/agent-smith/commit/9a1215c91381e2ca32cbfaa8e7f56888a6e033d1))
* **p0391a:** findings endpoint + degraded banner ([8d8163a](https://github.com/StrugglingPig/agent-smith/commit/8d8163a5e3e537eacd5689dcd3eefe00d260f00a))
* **p0391a:** startup findings contract; config rules record instead of throwing ([8e680eb](https://github.com/StrugglingPig/agent-smith/commit/8e680eb2741a4387a544ea99025aab34501e715e))
* **p0391a:** the diagnostic surface comes up first and unconditionally ([9bde8e5](https://github.com/StrugglingPig/agent-smith/commit/9bde8e5a7a76e80deaa13f2ba82201067c44d178))
* **p0391a:** the server always starts — aborting the startup is never justifiable ([bc3af2d](https://github.com/StrugglingPig/agent-smith/commit/bc3af2d8e340ac4dd1f99b81f792c962d4211539))
* pixel identity — mock CSS/DOM verbatim on all surfaces + system pages parity (p0343c, p0343d) ([2f708be](https://github.com/StrugglingPig/agent-smith/commit/2f708be27860a031597e0248d118da8da0463f41))
* pixel-identical dashboard surfaces — mock CSS/DOM ported verbatim (p0343c) ([9b763e9](https://github.com/StrugglingPig/agent-smith/commit/9b763e93ade2b9a5bbe525550b96b4992d943146))
* predictable capacity + run delete (p0336, p0337, p0338) ([164ce8c](https://github.com/StrugglingPig/agent-smith/commit/164ce8c2469929e8bdd94be71841c5fd0c02ced4))
* predictable capacity + run delete (p0336, p0337, p0338) ([054957d](https://github.com/StrugglingPig/agent-smith/commit/054957d956686d75e8106989a0da50ee85956226))
* principles-first prefix order in agent-plan-system prompt (p0323) ([048cd2e](https://github.com/StrugglingPig/agent-smith/commit/048cd2eb2316417644606fae6228ba682e6aa027))
* provider-aware history caching + open ledger + cheap analyzer (p0374) ([#456](https://github.com/StrugglingPig/agent-smith/issues/456)) ([4ec5254](https://github.com/StrugglingPig/agent-smith/commit/4ec5254afc86374e9f1dee55e2be19cd033749fb))
* pull requests — dedicated surface + prominent in run summary (p0347) ([b249206](https://github.com/StrugglingPig/agent-smith/commit/b249206a57a000bf9cb3d912ba78f86f6f8ffa94))
* pull requests page + prominent run-summary PR block — dashboard (p0347) ([bf6042c](https://github.com/StrugglingPig/agent-smith/commit/bf6042cd022524181e848b6ac6b220ae383acc8f))
* recall + precision on security-scan — history-secret severity and generated-code skip (p0333b, p0333c) ([f569655](https://github.com/StrugglingPig/agent-smith/commit/f569655f54001561a9c46057cbe664ffe52516ff))
* retire the batch path (p0312d) + shared methodology references (p0313b) ([3433c70](https://github.com/StrugglingPig/agent-smith/commit/3433c70b86e38b80b186c57f12a46cc28f56e0d6))
* revive Anthropic prompt caching and surface cached share per LLM call (p0323) ([1304152](https://github.com/StrugglingPig/agent-smith/commit/1304152e82ad3c1a36b5d7cdc4d21c66319b59d5))
* revive Anthropic prompt caching, surface cached share per LLM call (p0323) ([a76c440](https://github.com/StrugglingPig/agent-smith/commit/a76c440955cf9187fb4c3c5cf85e9dae3ca793ac))
* run rail and step detail from DB projections (p0388b) ([d8a6941](https://github.com/StrugglingPig/agent-smith/commit/d8a6941f6e6759ca30346a5126c9df224e4f762b))
* run rail from projections (p0388a + p0388b) ([91df54c](https://github.com/StrugglingPig/agent-smith/commit/91df54cbc6500f26ec9165d2d51e2d75e54394b4))
* run reliability + truthful viewer — corpse-pod reaper, capacity reconcile (p0355) ([a277a37](https://github.com/StrugglingPig/agent-smith/commit/a277a373987098b790f644c31f34d986c277c1e6))
* run story real data + config-studio connections — dashboard (p0344b, p0345b) ([f685e01](https://github.com/StrugglingPig/agent-smith/commit/f685e01951a521ce1dbb9e1d84d39b8c07f0e183))
* run story view — 5-beat storybar + verify summary over the trace (p0344) ([c3cfb0f](https://github.com/StrugglingPig/agent-smith/commit/c3cfb0fd72b298f0034ef43df6b5a74f740811f7))
* run-story real data + connections config entity (p0344b + p0345b backend) ([da10171](https://github.com/StrugglingPig/agent-smith/commit/da10171d73bf33662d9e5c2500120f841800d212))
* sandboxes reuse a warm package cache, and a killed command says why (p0407) ([337c813](https://github.com/StrugglingPig/agent-smith/commit/337c813bd350327c970b22d87c77ae5c9a56ce52))
* security-scan recall + precision — history-secret severity, generated-code skip (p0333b, p0333c) ([7f081a4](https://github.com/StrugglingPig/agent-smith/commit/7f081a4ad4539c6d797a27abd8a46ed08d401805))
* ships_code phase semantics + verify command discovery — no guessed filenames (p0400) ([ef3acc0](https://github.com/StrugglingPig/agent-smith/commit/ef3acc0f0a75e5ffa44e42eb6f4b0648e8982851))
* skills reload visibility on config change + python payload e2e proof (p0358) ([c1d6725](https://github.com/StrugglingPig/agent-smith/commit/c1d6725dfeea77c5142c6a9fdd65db5e8a9dc335))
* skills reload visibility on config change + python payload e2e proof (p0358) ([1c0acf1](https://github.com/StrugglingPig/agent-smith/commit/1c0acf142f7b96a98e2fee05828876711dd2c245))
* skills ship embedded in the release; pin becomes an override (p0325) ([3cdb0db](https://github.com/StrugglingPig/agent-smith/commit/3cdb0db0379e82c2cb29d06d7f0149db71bebbd2))
* SQL Server persistence provider + dashboard screenshots ([5fadef5](https://github.com/StrugglingPig/agent-smith/commit/5fadef5e71e150cc725c943b5b95978bab09f9fb))
* SQL Server persistence provider + dashboard screenshots in docs ([12b36a3](https://github.com/StrugglingPig/agent-smith/commit/12b36a3895f98d3a8540c47cb0bb95b04e6460f2))
* step attribution on persisted run rows (p0388a) ([9b38c8a](https://github.com/StrugglingPig/agent-smith/commit/9b38c8a48baa85c598d52d7926b2eb8648b08ce4))
* step classes condense the drawer to the run's story; sidebar rows single-line by default (p0398, p0395b) ([6454fa3](https://github.com/StrugglingPig/agent-smith/commit/6454fa388d0c445e82414d89747059fd1e87a335))
* system/rollup pages join the parity design system (p0343d) ([0e108c5](https://github.com/StrugglingPig/agent-smith/commit/0e108c55970eedfe7f0e75da89e9181c10388173))
* the account goes back to the agent that can close it (p0438) ([4a3aa8a](https://github.com/StrugglingPig/agent-smith/commit/4a3aa8a56841544574a70f9f45398298d8a487c6))
* the account goes back to the agent that can close it (p0438) ([f398e18](https://github.com/StrugglingPig/agent-smith/commit/f398e1843d88e005c81e2e353d0e54336da7768f))
* the account sees what the agent ran (p0452) ([8f6eee5](https://github.com/StrugglingPig/agent-smith/commit/8f6eee5f83a0e418a86948b33a90bd72a01b6a4a))
* the account sees what the agent ran (p0452) ([e70e555](https://github.com/StrugglingPig/agent-smith/commit/e70e555e3b1b65ef5e8ff90b8098d7619f1be264))
* the control flow explains itself — a diagram generated from the presets (p0408) ([67cd5df](https://github.com/StrugglingPig/agent-smith/commit/67cd5df73f20b09b83b9bbd252b5fe78f113ba2c))
* the cut is reviewed before it is built (p0422) ([d61a716](https://github.com/StrugglingPig/agent-smith/commit/d61a7164953ebe7847633428d03e6a8d2f74b3a8))
* the cut is reviewed before it is built, and the run explains itself ([3eb305c](https://github.com/StrugglingPig/agent-smith/commit/3eb305c01fbb4d1647862c44f9492b9112cf387e))
* the process is sized to the shape of the work (p0413) ([0d016ca](https://github.com/StrugglingPig/agent-smith/commit/0d016ca411c43ccf1f98adeb74c7bf47dc9a7833))
* the run explains itself on screen, and a live-target finding cites an endpoint (p0423b + p0429a) ([6953598](https://github.com/StrugglingPig/agent-smith/commit/69535982a52331a3007ac29c665a7a271cb0c7fd))
* the run explains itself on screen, and a live-target finding cites an endpoint (p0423b + p0429a) ([81f26b7](https://github.com/StrugglingPig/agent-smith/commit/81f26b7a6dbb35a220b52150cc3f7655dfd346fb))
* the run is watched on one screen and diagnosed on another (p0423b) ([0f93e3e](https://github.com/StrugglingPig/agent-smith/commit/0f93e3eb9a6a08200bc659b50ff008892bbf6a01))
* the run shows what is still coming (p0405) ([3eb7211](https://github.com/StrugglingPig/agent-smith/commit/3eb7211a0408fa2b4709bfaeb16d8c840d8463ce))
* the spec is the plan — ledger seeds from the phase draft, plan call leaves the phase path (p0394a) ([4f08976](https://github.com/StrugglingPig/agent-smith/commit/4f089760a81ea342915848332efa9cbb7bbcd791))
* the spec is the plan; step classes condense the drawer; single-line rows (p0394a + p0398 + p0395b) ([feccbe2](https://github.com/StrugglingPig/agent-smith/commit/feccbe212793d78d4e72785dde527d88c425299e))
* the step detail follows a live run (p0388d) ([396c45c](https://github.com/StrugglingPig/agent-smith/commit/396c45cbab79e52120baebd83d0434b3f6942700))
* the step detail follows a live run (p0388d) ([4cce465](https://github.com/StrugglingPig/agent-smith/commit/4cce4656458b837eb2a393f21bda4d834621abaf))
* ticket-scoped provisioning — scope first, spawn only whats needed, escalate on demand (p0331) ([61ef73b](https://github.com/StrugglingPig/agent-smith/commit/61ef73b983c076cfd70c256cf6d706d5b4c32545))
* wire sandbox memory-request into created-event; p0330-p0332 recorded done ([32f5021](https://github.com/StrugglingPig/agent-smith/commit/32f5021e415e10852cdd658a2636e837941b4ef7))


### Bug Fixes

* a citation written for a human is still a citation (p0422) ([a34437e](https://github.com/StrugglingPig/agent-smith/commit/a34437e39b292377433df290104372ebc8f82770))
* a command that cannot fail is not a verification (p0451) ([e094232](https://github.com/StrugglingPig/agent-smith/commit/e0942328a917082dcd29a38d48d9dad139f96f6c))
* a command that cannot fail is not a verification (p0451) ([3552aa0](https://github.com/StrugglingPig/agent-smith/commit/3552aa03869fed69679656e5a2ec47d669eae2dc))
* a cut with a finding beats no cut (p0447) ([ebb9472](https://github.com/StrugglingPig/agent-smith/commit/ebb94723f29d5e6dff488c9d1b35ff12f2bf5384))
* a declared command is a command line, and an imperfect answer is data (p0425 + p0426) ([f55b021](https://github.com/StrugglingPig/agent-smith/commit/f55b02152d72a7f7623944bcdc78a2b19b0100e7))
* a drain test waits for what it asserts (p0443) ([43469d9](https://github.com/StrugglingPig/agent-smith/commit/43469d99a4139ae8e72aeca435bf2a7644b1f81e))
* a drain test waits for what it asserts (p0443) ([0e09b54](https://github.com/StrugglingPig/agent-smith/commit/0e09b54ba1720eb06f4bffaab7619abf85ba5145))
* a job spawner always exists, so the server always starts ([ed65ebd](https://github.com/StrugglingPig/agent-smith/commit/ed65ebd5f3bce5546a0d1ac57486eb003aba3584))
* a knowledge phase can satisfy the acceptance gate (p0406) ([8518a43](https://github.com/StrugglingPig/agent-smith/commit/8518a4385bb34f36066460af75d501408be81225))
* a lockfile that can be ignored is not a lockfile (p0435) ([33251f5](https://github.com/StrugglingPig/agent-smith/commit/33251f5463f515b05500e82f99547ecba5c1d8cf))
* a lockfile that can be ignored is not a lockfile (p0435) ([f9c1617](https://github.com/StrugglingPig/agent-smith/commit/f9c16178c3d516362666051af9a37dff2dd1c533))
* a parked run is readable like every other (p0445) ([fa75a49](https://github.com/StrugglingPig/agent-smith/commit/fa75a49a1aae68bd6661dd7a3c9089c94cd41f64))
* a parked run is readable like every other (p0445) ([97b1cc1](https://github.com/StrugglingPig/agent-smith/commit/97b1cc1dba4d0dcaa6dd8f908a7939a1519facb2))
* a parked run says it needs you (p0440) ([ec768d9](https://github.com/StrugglingPig/agent-smith/commit/ec768d9ba139cbcbd2fe12bbb4cc9dd8406eb1b0))
* a phase starts without the last one's repair (p0444) ([67775cf](https://github.com/StrugglingPig/agent-smith/commit/67775cfa3832ae51ace1d85cb21ef02b2d00e9ad))
* a phase starts without the last one's repair (p0444) ([4956c36](https://github.com/StrugglingPig/agent-smith/commit/4956c363b36d67c9e02d58db4f9bfb56850f8255))
* a question in a repair pass is still asked (p0449) ([abb80c4](https://github.com/StrugglingPig/agent-smith/commit/abb80c4f7d0791ab229b32bf93296274f822e9d6))
* a question in a repair pass is still asked (p0449) ([ae924aa](https://github.com/StrugglingPig/agent-smith/commit/ae924aaa081fba075f2eb642c84fd70f0d83d387))
* a repeated step belongs to its phase, and the panel says what the run spent its time on (p0341g) ([c3f80b3](https://github.com/StrugglingPig/agent-smith/commit/c3f80b380a3fe2bdd582eb387c1803ee586260cf))
* a run id is shortened where it differs (p0441) ([79a2acf](https://github.com/StrugglingPig/agent-smith/commit/79a2acf2e3b807d11630bedbd33fd196e388174f))
* a run notice is not the ticket conversation (p0448) ([15b7bc7](https://github.com/StrugglingPig/agent-smith/commit/15b7bc78ebdfcb3c6a54049d9794694a065cb1bf))
* a run notice is not the ticket conversation (p0448) ([7f59147](https://github.com/StrugglingPig/agent-smith/commit/7f591475e18fb07634fb3f6794f9b7fe35e1e7ef))
* a shipped phase leaves the planned list (p0423b) ([ef417c4](https://github.com/StrugglingPig/agent-smith/commit/ef417c47fe0693edf4c82d94b1231599ca962238))
* a step that reaches a model cannot be declared deterministic (p0433) ([3df2b6d](https://github.com/StrugglingPig/agent-smith/commit/3df2b6daec702db4f5615e652a72a2955355cef6))
* a step that reaches a model cannot be declared deterministic (p0433) ([27d37ea](https://github.com/StrugglingPig/agent-smith/commit/27d37ea4d5c22de7d3289d687dc7c09a6152d274))
* accrue LLM cost per call at each call's own model pricing (p0359) ([6d5c8d9](https://github.com/StrugglingPig/agent-smith/commit/6d5c8d96dc3f04392e26dda8554a686666a67aeb))
* accurate master-loop cost, objective re-engagement, sub-agent cost + failure reason (p0341e) ([e6a5825](https://github.com/StrugglingPig/agent-smith/commit/e6a5825c1d37289c313435a7128936dc1e06babc))
* ActivityRow + FilterRail handle ExpectationRatified (exhaustive event surfaces) ([658a42d](https://github.com/StrugglingPig/agent-smith/commit/658a42dfb728e0e137c8ebf5a5a83078a2165342))
* add workflows:write permission for workflow file updates ([e285c5b](https://github.com/StrugglingPig/agent-smith/commit/e285c5b27e69b1f4b9138c61c0790de52c800322))
* analyzer finalize turn — capped exploration still yields a ProjectMap (p0385) ([82d56c4](https://github.com/StrugglingPig/agent-smith/commit/82d56c40c9f24bc38739f8e2ea68368a33741fde))
* analyzer finalize turn opens its own call scope (p0385) ([c52ae2b](https://github.com/StrugglingPig/agent-smith/commit/c52ae2bfa3b82088028e22148ee8a00efaeb990e))
* await the mid-run ledger flush in the tool call — fire-and-forget publish raced checkpoint teardown (p0356) ([d0bee0f](https://github.com/StrugglingPig/agent-smith/commit/d0bee0f98dbc107af4f6246afdc205d2381ccca7))
* bootstrap dispatch uses authoritative sandbox-repo map; speaking context-name sandbox keys (p0322b) ([4267fa7](https://github.com/StrugglingPig/agent-smith/commit/4267fa71957d6bf12f7f5a2e4e779053c621e324))
* checkout continuity, sub-agent config, cancel-persist, cost tracking, re-engage hardening (p0341e) ([728b738](https://github.com/StrugglingPig/agent-smith/commit/728b738cb68de287ec4b3941dea350595ed02c13))
* CI tests run against the catalog the build pins ([70d0bc1](https://github.com/StrugglingPig/agent-smith/commit/70d0bc1df184ca75fa4b2eec3db1ee60d57744cf))
* **ci:** build dashboard image amd64-only ([b0c55ef](https://github.com/StrugglingPig/agent-smith/commit/b0c55efa43f5215c6dacafbde22877852ee6596f))
* **ci:** build dashboard image amd64-only ([c9e5800](https://github.com/StrugglingPig/agent-smith/commit/c9e580071101ec595423a9a455c30a6912237977))
* correct upstream branch name ([e15a461](https://github.com/StrugglingPig/agent-smith/commit/e15a461d187571dda106b2e31aa6e475309303e8))
* correct workflow for GitHub App token push ([ceaf03a](https://github.com/StrugglingPig/agent-smith/commit/ceaf03ae4966d9ad9ffbd33e6b27c27945a78623))
* correct YAML formatting for prettier ([12490a6](https://github.com/StrugglingPig/agent-smith/commit/12490a64da9b86f4251a9fcb85e82c37631a0f2f))
* correct YAML formatting for prettier ([ba379e2](https://github.com/StrugglingPig/agent-smith/commit/ba379e2488234635bf6849765643d528bf1b4018))
* **dashboard:** inline cancel + delete on mission-control Needs-you cards ([d3c2eb4](https://github.com/StrugglingPig/agent-smith/commit/d3c2eb42dcc6691510190dc69a03bf923f991d9c))
* **dashboard:** mirror RunStoryRecordedEvent into hub-events.ts (CI drift gate) ([5937db1](https://github.com/StrugglingPig/agent-smith/commit/5937db1606b6c8f0154ea212fe05591f76669bf3))
* **dashboard:** the activity row survives an event it has never heard of ([3869dd9](https://github.com/StrugglingPig/agent-smith/commit/3869dd9ddace3ce105b8a3adb62a8ed97cfa74c3))
* **dashboard:** trace drawer — the detail pane is the wide reading area (was too thin) ([c898814](https://github.com/StrugglingPig/agent-smith/commit/c898814aa7f52cd3c37c2d30d56e7a4dc2b36254))
* **dashboard:** trace drawer detail pane is the wide reading area (was too thin) ([c3cdda2](https://github.com/StrugglingPig/agent-smith/commit/c3cdda281bde4b7367e1a0eb1309c41529c56878))
* de-flake p0378 drain tests on slow CI runners — generous polling deadlines ([10d205c](https://github.com/StrugglingPig/agent-smith/commit/10d205cfba3b63accd257d4d9ea439a82cb067d9))
* declared verify commands run at the repo root; derivation must declare ships_code (p0400a) ([71da1f2](https://github.com/StrugglingPig/agent-smith/commit/71da1f26354ab56ad7eb1442a510f292e73a2e00))
* declared verify commands run at the repo root; derivation must declare ships_code (p0400a) ([c11f672](https://github.com/StrugglingPig/agent-smith/commit/c11f67248c5538f7c4fde70ce83283b8b6122575))
* **docker:** copy SqlServer migrations csproj for restore caching ([2bb1cff](https://github.com/StrugglingPig/agent-smith/commit/2bb1cffa9b236ac106bae43085a819bb1b8ef0ab))
* drawer widths are fractions of the viewport; sidebar labels wrap (p0395a) ([a219127](https://github.com/StrugglingPig/agent-smith/commit/a219127d827c2e58b0711a5ee57ea2f79a1cd273))
* drawer widths are fractions of the viewport; sidebar labels wrap (p0395a) ([7d8871d](https://github.com/StrugglingPig/agent-smith/commit/7d8871d5dcd533f6a69d2f638dec0677c2c9985d))
* fetch origin ref before push to keep force-with-lease valid ([30044cc](https://github.com/StrugglingPig/agent-smith/commit/30044cceae950f4bae8ad25317901f3bacf60e61))
* grant workflows:write permission to sync fork ([79adc62](https://github.com/StrugglingPig/agent-smith/commit/79adc62d194d20435843778b28c676437bd22541))
* harness/composition tests boot an in-memory config DB (p0349) ([72264b9](https://github.com/StrugglingPig/agent-smith/commit/72264b97157b674b1da38ad3b2dfc281e8842367))
* **hooks:** phase gate must test the tree the commit runs in ([18d89d5](https://github.com/StrugglingPig/agent-smith/commit/18d89d548a8e787697ee394dea60640da23a701d))
* **hooks:** phase gate must test the tree the commit runs in ([6c728c3](https://github.com/StrugglingPig/agent-smith/commit/6c728c353ed3f57cdbc48cc718b6a2d601c199c4))
* live-run findings — plan-JSON regression, spec-commit identity, run-viewer feedback (p0394 + p0395) ([3e0d0e5](https://github.com/StrugglingPig/agent-smith/commit/3e0d0e55f3a77b622e6db81da868998aac2c49b5))
* merge main — keep both p0348 hardening + p0347 PR fields on RunSnapshot (p0348) ([2c5037d](https://github.com/StrugglingPig/agent-smith/commit/2c5037de791db68f220cd6f0e5a9c0b34b58457f))
* mirror ConfigChanged/ConfigReloaded system-events in the dashboard (hub-events drift) ([d01d40b](https://github.com/StrugglingPig/agent-smith/commit/d01d40bb3de6e4421fce828aa57189d832267f40))
* mirror ExpectationRatifiedEvent into hub-events.ts (CI drift check) ([6c8112c](https://github.com/StrugglingPig/agent-smith/commit/6c8112cfca9105fdc90a03f8bb3f19229be3d99b))
* mirror RunBudgetResolvedEvent in hub-events.ts + activity/filter surfaces (p0357) ([85f0bca](https://github.com/StrugglingPig/agent-smith/commit/85f0bca24b8f5d2802f770020dc1f4d1efea34f0))
* multi-repo plan rules render inside the template; staged commits ensure git identity (p0394) ([b225080](https://github.com/StrugglingPig/agent-smith/commit/b2250805bedb9afbd4653250dae8eb2f51685687))
* no PR for run-record-only init diffs; real commit failures surface honestly (p0322c) ([2aafe8e](https://github.com/StrugglingPig/agent-smith/commit/2aafe8e7d41f3a32c340ec7e9431f28c7eb24e2e))
* no startup path throws, and the CLI reports what the server would (p0391b) ([feb0027](https://github.com/StrugglingPig/agent-smith/commit/feb002786059e6e79f7f17950173d7154b5f5260))
* one tool result cannot blow the context (p0422) ([9896774](https://github.com/StrugglingPig/agent-smith/commit/98967748e5bfe3640ae1ebb8efaa9b237eb0b90d))
* OpenAI cache-read truth + empty-pass re-engagement stop (p0365) ([#452](https://github.com/StrugglingPig/agent-smith/issues/452)) ([5906996](https://github.com/StrugglingPig/agent-smith/commit/590699650c5c9ec115d43ffd015c72d0ec0e1224))
* **p0348:** five operator-reported production defects ([b841b11](https://github.com/StrugglingPig/agent-smith/commit/b841b1152e90b69c5097c0681c98bf668bf66765))
* **p0348:** five operator-reported production defects ([a02d8a0](https://github.com/StrugglingPig/agent-smith/commit/a02d8a0a2811d9ce222f4550f18c9973f7658295))
* **p0350:** stop a big run from crashing on its own throttle and losing its PRs ([e112214](https://github.com/StrugglingPig/agent-smith/commit/e112214d93eb4f58443c6ef261b6c407091c6a6a))
* **p0350:** stop a big run from crashing on its own throttle and losing its PRs ([97fe8ea](https://github.com/StrugglingPig/agent-smith/commit/97fe8ea88aa7bfe288af5abd47076529b2786ab7))
* **p0391a:** bound each startup probe so a blackholed dependency cannot hold the port shut ([2bbb1d8](https://github.com/StrugglingPig/agent-smith/commit/2bbb1d8955446746cc301571ff44e5858bed8da8))
* **p0391:** park-status check as a pure load-time rule, no DI churn ([92c3c19](https://github.com/StrugglingPig/agent-smith/commit/92c3c19176da8ad8bdbdf6b22d3f32febc9944b3))
* per-repo scope verdicts — confident exclusions survive unrelated doubt (p0386) ([8dd6123](https://github.com/StrugglingPig/agent-smith/commit/8dd61233ca88143b01ca7006675cbd4a93e39e8f))
* pipeline hardening — execute-prompt tokens, rate estimate, AzDO PR limit, plan-decision noise ([3a67dc6](https://github.com/StrugglingPig/agent-smith/commit/3a67dc673a4ab5c5765675d23009fee8d9cfd72c))
* pipeline hardening (execute-prompt tokens, rate estimate, AzDO PR limit, plan-decision noise) ([1b8606e](https://github.com/StrugglingPig/agent-smith/commit/1b8606ef73e80c51c203fa9a1582b34ca2f9a680))
* plan/contract/ledger/keystone enumerate every scoped repo — no primary-repo collapse (p0384) ([11e3944](https://github.com/StrugglingPig/agent-smith/commit/11e3944d83bc1e8923af8ba37c95b092050e724f))
* re-resolve RunSnapshot vs merged p0348 LiveCompute + p0347 (p0350) ([4d9f4fb](https://github.com/StrugglingPig/agent-smith/commit/4d9f4fbf241415fdd4347f067c4bc0deaadf8eee))
* re-run checks out the existing ticket branch, building on prior … ([653b122](https://github.com/StrugglingPig/agent-smith/commit/653b12222485ded5b452425709324aed16b507f6))
* re-run checks out the existing ticket branch, building on prior work (p0341e) ([47d891e](https://github.com/StrugglingPig/agent-smith/commit/47d891e52ba8c902ae97a04d5d2760eb275cb523))
* real x/y run progress, sandbox repo attribution + speaking keys, no run-record-only init PRs (p0322a-c) ([a25b585](https://github.com/StrugglingPig/agent-smith/commit/a25b585e12ac395a1209b6369f27243bf1f0f565))
* reaper loop tests wait on loop progress, not wall clock (p0383) ([99e890a](https://github.com/StrugglingPig/agent-smith/commit/99e890afebdf254bc3feed6f4c884d7c237ef5aa))
* reaper loop tests wait on loop progress, not wall clock (p0383) ([7398aa2](https://github.com/StrugglingPig/agent-smith/commit/7398aa21ea047042ea1681e09ab1deeb2d05c549))
* reaper spares in-process live runs + suspend grace after host sleep (p0383) ([6d8d4bb](https://github.com/StrugglingPig/agent-smith/commit/6d8d4bb7b02c20f3090f38ce61ae4604de9712f8))
* reaper suspend guards, multi-repo plan enumeration, analyzer finalize turn, per-repo scope verdicts, run-summary humanize (p0383-p0387) ([428845b](https://github.com/StrugglingPig/agent-smith/commit/428845bdce7fae620f95a69ec271ca4da223d970))
* release publish — keep RID/publish globals out of the skills-packaging tool (NETSDK1047) ([4609900](https://github.com/StrugglingPig/agent-smith/commit/46099007dff0093b6ede7c942fde62af25559484))
* release publish no longer flows RID/publish globals into the skills-packaging tool ([c96facd](https://github.com/StrugglingPig/agent-smith/commit/c96facd67fa324402ab04ae9fa4ddafe938c45d7))
* remove accidentally committed node_modules self-symlink (broke dashboard CI) ([4a1a66b](https://github.com/StrugglingPig/agent-smith/commit/4a1a66b4331cea10834df1abb2461c7056c69aeb))
* rename GITHUB_TOKEN env to GH_TOKEN (use PAT with workflow scope) ([d858c2e](https://github.com/StrugglingPig/agent-smith/commit/d858c2eeb0c9191e7219d317527601934f5d75d6))
* repoint homepage 'Get started' links to a live docs page (p0338) ([9bd119a](https://github.com/StrugglingPig/agent-smith/commit/9bd119a9f699983af5cb78054e255ec65c6c319b))
* repoint homepage 'Get started' links to a live docs page (p0338) ([557eeca](https://github.com/StrugglingPig/agent-smith/commit/557eecaf06740d543253b97a9fd427ed5a05d8d0))
* resolve p0347 PR-surfacing overlap toward p0350's crash-resilient path (p0350) ([c7a4c13](https://github.com/StrugglingPig/agent-smith/commit/c7a4c1335542342968de2138603a3c7f48a4361a))
* retired plan commands classify by literal name — old run records keep their step class ([26f80df](https://github.com/StrugglingPig/agent-smith/commit/26f80df5d9f5c00164348f3b4cc0586a51d33960))
* run summaries humanize raw provider error payloads (p0387) ([6fae77c](https://github.com/StrugglingPig/agent-smith/commit/6fae77c564033ccc3c5006a9dbc44b678a7e7c8d))
* run-viewer feedback — done-list rendering, resizable drawer, sourced phase documents, step labels (p0395) ([3ff226d](https://github.com/StrugglingPig/agent-smith/commit/3ff226d8aa666deeb4e671b912974ed0283093db))
* runs list shows real x/y progress and init runs carry the ticket title (p0322a) ([9905759](https://github.com/StrugglingPig/agent-smith/commit/9905759a9e3616ef78147284b1a774c011904857))
* sandbox idle exit consults run liveness — no more 1-hour suicide of a healthy run (p0360b) ([3d7a061](https://github.com/StrugglingPig/agent-smith/commit/3d7a061a6094687a485e7ffab001649b9aceb2df))
* sandbox idle wait survives transient Redis; LiveLLM plan-call golden (p0396 + p0397) ([ba7571e](https://github.com/StrugglingPig/agent-smith/commit/ba7571ea8017ae7ec614f32e30b69d97cabaa1a4))
* sandbox idle wait survives transient Redis; vanish summary tells the true exit cause (p0396) ([db3c5d8](https://github.com/StrugglingPig/agent-smith/commit/db3c5d8aae179fd83cb6316d7a253dc740c24ab4))
* serialize run-detail fetches — list ticks no longer cancel them (p0359) ([9630892](https://github.com/StrugglingPig/agent-smith/commit/963089269de4bdc3b65d23093a7af03d1fa0dab8))
* sort discovered repos alphabetically in the studio repo picker ([1768037](https://github.com/StrugglingPig/agent-smith/commit/17680373dcc6eb17e598cae118a8e529970dfd6d))
* sort discovered repos alphabetically in the studio repo picker ([1ccd1da](https://github.com/StrugglingPig/agent-smith/commit/1ccd1dae0d729898766263e2adece7ed737f1dba))
* spec-set fidelity + hygiene; ships_code phase semantics + verify command discovery (p0399 + p0400) ([bf0c383](https://github.com/StrugglingPig/agent-smith/commit/bf0c3834ac4b372f1a414451b69791a1aa049952))
* sub-agents get the master's real AgentConfig, not an empty default (p0341e) ([ced2d58](https://github.com/StrugglingPig/agent-smith/commit/ced2d58752ca1004798f0124b3d0e03e9322c031))
* the agent is told what the framework staged for it (p0422) ([0ce92ff](https://github.com/StrugglingPig/agent-smith/commit/0ce92ff484a46143ddd78f2f8b133dd76ef311b8))
* the build gate reads the branch, and a citation may name several commands (p0422) ([fef8e05](https://github.com/StrugglingPig/agent-smith/commit/fef8e05e02f263430272db0db668d197628e224f))
* the conversation carries what the operator said, not our echo (p0424) ([551994e](https://github.com/StrugglingPig/agent-smith/commit/551994e39019e531bc7c06a0684a33cca9fd5bb5))
* the cut reviewer judges what it saw, and a cut with a finding survives (p0446, p0447) ([2c1a2f9](https://github.com/StrugglingPig/agent-smith/commit/2c1a2f93ba2e3e41e3a89a0d7327a404791dbbf9))
* the deliverable is declared, not defaulted — and the decidable coding principles get teeth (p0400b, p0400c, p0401, p0403) ([#499](https://github.com/StrugglingPig/agent-smith/issues/499)) ([2acfb1f](https://github.com/StrugglingPig/agent-smith/commit/2acfb1fb38a2ea18b6c81a040c8be3154401a6e1))
* the gate runs after the work it judges (p0437) ([0371354](https://github.com/StrugglingPig/agent-smith/commit/0371354488c6542c1c68b1c54a62453218c1c7a2))
* the gate runs after the work it judges (p0437) ([a4fc67e](https://github.com/StrugglingPig/agent-smith/commit/a4fc67e4b9ad2b899a424ec68b55e1b669d6e801))
* the git identity is set once at checkout, and the working state carries the diff (p0411) ([1215899](https://github.com/StrugglingPig/agent-smith/commit/1215899064ef1d1660dd239797221f5334b20ceb))
* the not-in-ticket verdict needs the whole ticket (p0446) ([2f06328](https://github.com/StrugglingPig/agent-smith/commit/2f06328bc4d856fc093c882e8b4ddb16f2325bbe))
* the p0453 test stub follows p0454's poster signature ([fc26dec](https://github.com/StrugglingPig/agent-smith/commit/fc26dec57e59ec22c627ae92a6cf3a313450bedc))
* the PR survives a provider blip, the suite migrates once, and the why-page wears the run's header (p0434, p0432) ([f46c10f](https://github.com/StrugglingPig/agent-smith/commit/f46c10fc8724f08969fa1d4a7133c9ae9a0284b2))
* the preflight knows both shapes an agent's model can take (p0436) ([efa9a16](https://github.com/StrugglingPig/agent-smith/commit/efa9a169939b5adb96af9828d840cb2b55c391a8))
* the preflight knows both shapes an agent's model can take (p0436) ([a29da95](https://github.com/StrugglingPig/agent-smith/commit/a29da9554c59bd42b0fd4428802fa6335c85cb4a))
* the principles reader survives both catalog layouts (p0312a) ([2cf92c5](https://github.com/StrugglingPig/agent-smith/commit/2cf92c56b5123c3735325822ee3533d8e33b4217))
* the record guard survives its own success (p0430) ([c1b12f3](https://github.com/StrugglingPig/agent-smith/commit/c1b12f3f4366f467b180c3217361266f10c139aa))
* the server sends the shape it declares (p0456) ([6ac3962](https://github.com/StrugglingPig/agent-smith/commit/6ac39624f4a1e606ed0e699d8be960ddadef8b5a))
* the session batch — repair attribution, work breakdown, PR resilience, one-migration suite, parked runs, run ids (p0341g, p0432, p0434, p0440, p0441) ([b10ab78](https://github.com/StrugglingPig/agent-smith/commit/b10ab78ff79b7c71404930e5059a531bc60de973))
* the thread crosses the pass boundary (p0341f) ([ee8d97d](https://github.com/StrugglingPig/agent-smith/commit/ee8d97d796fa45d39c7f53d9f15c9f678115fd07))
* the thread crosses the pass boundary (p0341f) ([ff99482](https://github.com/StrugglingPig/agent-smith/commit/ff994823b4903be417fae379423f16dd5a235e9a))
* the tracker dialog shows the lists it holds (p0455) ([16921bd](https://github.com/StrugglingPig/agent-smith/commit/16921bdb2b4a29a624a2360e6f712f2b5aaccf80))
* the trail row renders a ledger transition (p0374a) ([2668501](https://github.com/StrugglingPig/agent-smith/commit/26685018fc81c6243939477cd325d3a244e51faa))
* the worker answers as the model, not as itself (p0424) ([47495a6](https://github.com/StrugglingPig/agent-smith/commit/47495a6af51e4bb455e57b37bc51fb5fa67cc714))
* thinking-block cache + 4xx-retry + pricing + p0377 security spec (p0376) ([#457](https://github.com/StrugglingPig/agent-smith/issues/457)) ([21e4d2e](https://github.com/StrugglingPig/agent-smith/commit/21e4d2e16bd101b8af3929a589f9d550cf86d4a0))
* ticket segments decode to text; a spec revision fully replaces the set (p0399) ([22deb0c](https://github.com/StrugglingPig/agent-smith/commit/22deb0c0735ee0b44bcfa62d52213862348e66ff))
* tracker workflow fields (trigger/open/done/failed status) editable in the config studio ([5a5055d](https://github.com/StrugglingPig/agent-smith/commit/5a5055d5b96e837d5549ff08ca89ec6eaa34c240))
* tracker workflow fields (trigger/open/done/failed status) editable in the config studio ([e7cd13f](https://github.com/StrugglingPig/agent-smith/commit/e7cd13f2aaa7f2f3f8cedfa84cb8daa1f089dd75))
* use --force instead of --force-with-lease to avoid stale ref issues ([17df9c7](https://github.com/StrugglingPig/agent-smith/commit/17df9c7b86aaf3935260ef5e3dccc47333bb3239))
* use dynamic branch detection from fork default branch ([4e4f21e](https://github.com/StrugglingPig/agent-smith/commit/4e4f21e589df123ebd73768261e0a8048b5b8ffe))
* use GH_TOKEN PAT (workflow scope) for fork sync ([5c11ce2](https://github.com/StrugglingPig/agent-smith/commit/5c11ce22288a553a44c8822e7fdc19f85d53a9e4))
* use HTTPS instead of SSH for upstream remote ([b61e76d](https://github.com/StrugglingPig/agent-smith/commit/b61e76d4ffef6966654e98d15e096e804115b9d0))
* vanish-class failures terminalize the ticket (p0381) ([b102c23](https://github.com/StrugglingPig/agent-smith/commit/b102c237982ac5aa2d43f6e49bf61f8219bd8332))
* vanish-class failures terminalize the ticket (p0381) ([5549ad9](https://github.com/StrugglingPig/agent-smith/commit/5549ad9a95621d67277b3061458d0bdd422c049a))
* wall-time-cancelled runs persist partial work; operator cancel still aborts (p0341e) ([7b2b7a2](https://github.com/StrugglingPig/agent-smith/commit/7b2b7a2534e5f54ef59ad0c3b3bf79ae8152921e))
* **website:** drop the fake `agent-smith fix` CLI demo from the landing page ([#447](https://github.com/StrugglingPig/agent-smith/issues/447)) ([348b7d7](https://github.com/StrugglingPig/agent-smith/commit/348b7d783949042fc5ca14c628ea1cb1d5eb747d))
* workflow ([bfbebbf](https://github.com/StrugglingPig/agent-smith/commit/bfbebbf51eacedb3a32d6d905a85a728e137e44e))
* workflow ([0e5387b](https://github.com/StrugglingPig/agent-smith/commit/0e5387b359ba5231a5c9be7f99e3dd02504f3c31))
* working-status comment posts once per logical run, not per capacity relaunch ([9219650](https://github.com/StrugglingPig/agent-smith/commit/92196503e5778f54a5f9802dc578e5cb536021ee))
* working-status ticket comment posts once per logical run, not per capacity relaunch ([bf7392c](https://github.com/StrugglingPig/agent-smith/commit/bf7392c733b33cb54d925082d246e9587c4647c0))
